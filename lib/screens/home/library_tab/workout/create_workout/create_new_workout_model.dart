...
// final createNewWorkoutModelProvider = ChangeNotifierProvider.autoDispose(
//   (ref) => CreateNewWorkoutModel(),
// );

// class CreateNewWorkoutModel with ChangeNotifier {
//   late AuthBase? auth;
...
//   void saveTitle(BuildContext context, CreateNewWorkoutModel model) {
...
//   void saveMainMuscleGroup(BuildContext context, CreateNewWorkoutModel model) {
