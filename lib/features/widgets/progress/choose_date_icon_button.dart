...
class ChooseDateIconButton extends ConsumerWidget {
  final User user;
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return TextButton(
      ...
      onPressed: enabled ? () => _showCalendar(context, ref) : null,
      child: Row(
  ...
  Future<bool?> _showCalendar(BuildContext context, WidgetRef ref) {
