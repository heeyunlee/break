...
class NutritionMealTypeListTile extends StatefulWidget {
  ...
  @override
  State<NutritionMealTypeListTile> createState() =>
      _NutritionMealTypeListTileState();
}

class _NutritionMealTypeListTileState extends State<NutritionMealTypeListTile> {
  @override
  Widget build(BuildContext context) {
    ...
    return ListTile(
      ...
      trailing: Text(
        EnumToString.convertToString(widget.nutrition.type, camelCase: true),
      ...
      onTap: () => showModalBottomSheet(
        ...
        builder: (context) => Consumer(
          builder: (context, ref, child) {
            final model =
                ref.watch(editNutritionModelProvider(widget.nutrition));
