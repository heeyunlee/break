...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(numberOfWorkout) => "Add ${numberOfWorkout} Workouts";

  static String m1(workoutTitle) => "Added ${workoutTitle} to this routine";

  static String m2(url) => "Could Not Launch: ${url}";

  static String m3(username) => "Delete ${username}\'s Account?";

  static String m4(chip) => "No ${chip} routines yet...";

  static String m5(name) => "Welcome, ${name}! Let\'s get lifting";

  static String m6(workout) => "No ${workout} workouts...";

  static String m7(displayName) => "Hello,\n${displayName}";

  static String m8(difference) => "${difference}% to your goal!";

  static String m9(weightDif) => "${weightDif} to your goal!";

  static String m10(muscle, equipment) =>
      "${muscle} workout using ${equipment}";

  static String m11(displayName) => "Welcome Back, ${displayName}!";

  static String m12(days) => "${days} days ago";

  static String m13(hours) => "${hours} hours ago";

  static String m14(minutes) => "${minutes} minutes ago";

  static String m15(seconds) => "${seconds} seconds ago";

  static String m16(today) => "Today Is \n${today}";

  static String m17(dataType) =>
      "Updated equipment required for the ${dataType}";

  static String m18(dataType) => "Updated this ${dataType}\'s location";

  static String m19(dataType) =>
      "Updated main muscle group for this ${dataType}";

  static String m20(dataType) => "Updated unit of mass for this ${dataType}";

  static String m21(equipment) => "using ${equipment}";

  static String m22(mainMuscleGroup) => " worked out ${mainMuscleGroup}";

  static String m23(equipments) => "Using ${equipments}";

  static String m24(subtitle) => "Rest for ${subtitle}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "addMeasurementSnackbarTitle":
            MessageLookupByLibrary.simpleMessage("Add Measurement"),
        "addMoreData": MessageLookupByLibrary.simpleMessage("Add More Data!"),
        ...
        "byEquipment": MessageLookupByLibrary.simpleMessage("By Equipment"),
        ...
        "createNewWorkoutSnackbar":
            MessageLookupByLibrary.simpleMessage("Created a new workout!"),
        ...
        "deleteRoutinekButtonText":
            MessageLookupByLibrary.simpleMessage("Delete Routine"),
        "deleteWorkoutSet":
            MessageLookupByLibrary.simpleMessage("Delete a set"),
        ...
        "deleteWorkoutkButtonText":
            MessageLookupByLibrary.simpleMessage("Delete Workout"),
        "deletedARestMessage":
            MessageLookupByLibrary.simpleMessage("Deleted a rest set!"),
        "deletedASet":
            MessageLookupByLibrary.simpleMessage("Deleted a workout set!"),
        ...
        "descriptionHintText":
            MessageLookupByLibrary.simpleMessage("Add description here!"),
        ...
        "displayNameEmptyContent": MessageLookupByLibrary.simpleMessage(
        ...
        "equipmentRequired":
            MessageLookupByLibrary.simpleMessage("Equipment Required"),
        "equipmentRequiredAlertContent": MessageLookupByLibrary.simpleMessage(
        ...
        "featureDiscoveryCustomizeWidgetTitle":
            MessageLookupByLibrary.simpleMessage("Customize Your Widgets"),
        ...
        "itemsAutoGenerated":
            MessageLookupByLibrary.simpleMessage("Items (Auto-generated)"),
        ...
        "lastNameHintText": MessageLookupByLibrary.simpleMessage("Doe"),
        "lastNameValidationText":
            MessageLookupByLibrary.simpleMessage("Please Add your last name"),
        ...
        "loggedRoutineHistorySnackbar":
            MessageLookupByLibrary.simpleMessage("Logged an activity"),
        ...
        "mainMuscleGroupAlertContent": MessageLookupByLibrary.simpleMessage(
            "Please Select at least one Main Muscle Group"),
        "mainMuscleGroupAlertTitle": MessageLookupByLibrary.simpleMessage(
        ...
        "routinesLowerCase": MessageLookupByLibrary.simpleMessage("routines"),
        ...
        "selectMealTypeAlertTitle":
            MessageLookupByLibrary.simpleMessage("Select Meal Type!"),
        "selectMeapTypeAlertContent": MessageLookupByLibrary.simpleMessage(
        ...
        "setWeightGoalSnackbarMessage": MessageLookupByLibrary.simpleMessage(
            "You\'ve successfully set the weight goal"),
        "setWeightGoalSnackbarTitle":
            MessageLookupByLibrary.simpleMessage("Set Weight Goal"),
        "setWeightsDailyGoal":
        ...
        "shortPasswordValidationText": MessageLookupByLibrary.simpleMessage(
        ...
        "signOutFailedMessage":
            MessageLookupByLibrary.simpleMessage("Sign out has failed..."),
        "signOutSnackbarMessage": MessageLookupByLibrary.simpleMessage(
            "You have signed out of your account"),
        "signOutSnackbarTitle":
            MessageLookupByLibrary.simpleMessage("Sign Out"),
        "signUp": MessageLookupByLibrary.simpleMessage("Sign Up"),
        "signingIn": MessageLookupByLibrary.simpleMessage("Signing In..."),
        "skeletalMuscleMass":
            MessageLookupByLibrary.simpleMessage("Skeletal Muscle Mass"),
        ...
        "startYoutubeWorkoutAlertTitle":
            MessageLookupByLibrary.simpleMessage("YouTube Workout In Progress"),
        "stats": MessageLookupByLibrary.simpleMessage("Stats"),
        "stopTheWorkout":
            MessageLookupByLibrary.simpleMessage("Stop the workout"),
        ...
        "totalFat": MessageLookupByLibrary.simpleMessage("Total Fat"),
        "totalVolumeHintText":
            MessageLookupByLibrary.simpleMessage("Total Volume: in"),
        "totalVolumeValidatorText":
            MessageLookupByLibrary.simpleMessage("Please enter volumes!"),
        ...
        "workoutHintText":
            MessageLookupByLibrary.simpleMessage("Custom Workout Name"),
        ...
        "yourDisplayName":
            MessageLookupByLibrary.simpleMessage("Your Display Name"),
        "yourFeedbackMatters":
            MessageLookupByLibrary.simpleMessage("Your Feedback Matters!"),
